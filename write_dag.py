"""Run this script from your project root to write the correct DAG file:
   python write_dag.py
"""
import os
...
with open("airflow/dags/transaction_pipeline_dag.py", "w", encoding="utf-8") as f:
    f.write(dag_content)

print("DAG file written successfully to airflow/dags/transaction_pipeline_dag.py")